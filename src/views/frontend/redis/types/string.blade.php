<div id="page-title">
    ...
    <div id="key-options" data-database="{{ \Session::get('activeDatabase') }}" data-key="{{ $Object['name'] }}" data-value="{{ $Object['value'] }}" data-ttl="{{ $Object['ttl'] }}">
        <a class="" href="" title="Edit Key"> <i class="fa fa-pencil"></i> </a>
